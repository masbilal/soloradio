...
<?php
	if($id != 0){
		$data = $this->func->getProgram($id,"semua");
	}
?>

<form id="postingan" action="<?=site_url("ngadimin/programform")?>" enctype="multipart/form-data" method="POST">
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label>Foto Thumbnail Program</label>
			...
			<div class="form-group">
				<label>Opening/Promo Audio</label>
